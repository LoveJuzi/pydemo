...
def main():
    ...
    objectColor = glm.vec3(1.0, 0.5, 0.31)
    ...
    objectShader = Shader().init(resourceFile("shader19_obj.vs"),
                                 resourceFile("shader20_obj.fs"))
    ...
    while True:
        ...
        objectShader.setVec3v("material.ambient", objectColor)
        objectShader.setVec3v("material.diffuse", objectColor)
        objectShader.setVec3v("material.specular", 0.5 * lightColor)
