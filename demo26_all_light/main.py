...
def getPointLightPositions():
    return [glm.vec3(0.7,  0.2,  2.0),
...
def main():
    ...
    lightPositions = getPointLightPositions()
    ...
    while True:
        ...
        for index, lightPos in enumerate(lightPositions):
            model = glm.mat4()
        ...
        objectShader.setVec3v("dirLight.direction", glm.vec3(-0.2, -1.0, -0.3))
        objectShader.setVec3v("dirLight.ambient", 0.05 * lightColor)
        objectShader.setVec3v("dirLight.diffuse", 0.4 * lightColor)
        objectShader.setVec3v("dirLight.specular", 0.5 * lightColor)

        objectShader.setVec3v("pointLights[0].position", lightPositions[0])
        objectShader.setVec3v("pointLights[0].ambient", 0.05 * lightColor)
        objectShader.setVec3v("pointLights[0].diffuse", 0.8 * lightColor)
        objectShader.setVec3v("pointLights[0].speculuar", 1.0 * lightColor)
        ...
        objectShader.setVec3v("pointLights[1].position", lightPositions[1])
        objectShader.setVec3v("pointLights[1].ambient", 0.05 * lightColor)
        objectShader.setVec3v("pointLights[1].diffuse", 0.8 * lightColor)
        objectShader.setVec3v("pointLights[1].speculuar", 1.0 * lightColor)
        ...
        objectShader.setVec3v("pointLights[2].position", lightPositions[2])
        objectShader.setVec3v("pointLights[2].ambient", 0.05 * lightColor)
        objectShader.setVec3v("pointLights[2].diffuse", 0.8 * lightColor)
        objectShader.setVec3v("pointLights[2].speculuar", 1.0 * lightColor)
        ...
        objectShader.setVec3v("pointLights[3].position", lightPositions[3])
        objectShader.setVec3v("pointLights[3].ambient", 0.05 * lightColor)
        objectShader.setVec3v("pointLights[3].diffuse", 0.8 * lightColor)
        objectShader.setVec3v("pointLights[3].speculuar", 1.0 * lightColor)
        ...
        objectShader.setVec3v("spotLight.position", gameParam.camera().pos())
        objectShader.setVec3v("spotLight.direction", gameParam.camera().front())
        objectShader.setVec3v("spotLight.ambient", 0.0 * lightColor)
        objectShader.setVec3v("spotLight.diffuse", 1.0 * lightColor)
        objectShader.setVec3v("spotLight.specular", 1.0 * lightColor)
